...
public class Addition implements GameRule {
    Scanner sc = new Scanner(System.in);

    @Override
    public void startGame() {
        System.out.println("Starting the addition game...");
        ...
        int result = add(numbers1, numbers2);
        System.out.println("The maximum sum of corresponding elements is: " + result);

    }

    @Override
    public void endGame() {
        System.out.println("Ending the addition game...");
    }

    public int add(List<Integer> l1, List<Integer> l2) {
