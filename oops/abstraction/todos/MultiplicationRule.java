...
public class MultiplicationRule implements GameRule {
    ...
    public void startGame() {
        System.out.println("Starting the multiplication game...");
        ...
        int result = multiply(numbers1, numbers2);
        System.out.println("The maximum product of corresponding elements is: " + result);
    }

    @Override
    public void endGame() {
        System.out.println("Ending the multiplication game...");
    }

    public int multiply(List<Integer> l1, List<Integer> l2) {
